...
input_width = float(input("What is the width of the rectangle?"))
input_height = float(input("What is the height of the rectangle?"))
...
print("The length of the diagonal is",round(shape.calculate_diagonal(),2),"cm")
